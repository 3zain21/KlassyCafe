...
<body>
    <div class="container-scroller">
        ...
        <div style="margin: auto; width: 70%">
            <div>
                <form class="form-horizontal" action="<?php echo e(url('/update', $data->id)); ?>" enctype="multipart/form-data"
                    method="post">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="ssn" value="<?php echo e($data->title); ?>"
                                    name="title" />
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="fname" value="<?php echo e($data->price); ?>"
                                    name="price" />
                            </div>
                        </div>
                        <div class="form-group row">
...
<?php /**PATH E:\My_Projects\laravel_youtube\first\resources\views/admin/updateview.blade.php ENDPATH**/ ?>